...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    const stackPositionPx = parsePercentage(stackPosition as any, containerHeight);
    const scaleEndPositionPx = parsePercentage(scaleEndPosition as any, containerHeight);
